    ...
    neural: [
      {
        ...
        caption: 'Prompt | The left arm picks up the Banana on the table and places it in the Blue Plate. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the Mango on the table and places it inside the Cardboard Box. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picks up the lime on the table and places it on the light green plate. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the red apple on the table and places it on the gray towel. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picks up the peach on the table and places it on the baking pan. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the red apple on the table and places it on the cutting board. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picks up the green pear on the table and places it on the blue checkered bowl. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the starfruit on the table and places it on the cloth basket. | ✅'
      },
    ],
  },
  seen_2: {
    neural: [
      {
        ...
        caption: 'Prompt | Both arms fold the bottom of the white short sleeve to the middle. They then pull the shirt toward the edge of the table. Next, both arms fold the top of the shirt down to the middle. Finally, the right arm grasps the collar and folds it down to complete the task. | ⚠️'
      },
      {
      ...
      },
      {
        ...
        caption: 'Prompt | Both arms fold the bottom of the green short sleeve to the middle. They then pull the shirt toward the edge of the table. Next, both arms fold the top of the shirt down to the middle. Finally, the right arm grasps the collar and folds it down to complete the task. | ⚠️'
      },      
      {
        ...
        caption: 'Prompt | Both arms fold the bottom of the logo short sleeve to the middle. They then pull the shirt toward the edge of the table. Next, both arms fold the top of the shirt down to the middle. Finally, the right arm grasps the collar and folds it down to complete the task. | ⚠️'
      },
      {
        ...
        caption: 'Prompt | Both arms fold the bottom of the gray short sleeve to the middle. They then pull the shirt toward the edge of the table. Next, both arms fold the top of the shirt down to the middle. Finally, the left arm grasps the collar and folds it down to finish. | ⚠️'
      },
      {
        ...
        caption: 'Prompt | Both arms fold the bottom of the blue short sleeve to the middle. They then pull the shirt toward the edge of the table. Next, both arms fold the top of the shirt down to the middle. Finally, the right arm grasps the collar and folds it down to complete the task. | ⚠️'
      },
    ...
    neural: [
      {
        ...
        caption: 'Prompt | Both arms fold the bottom of the tan shorts toward the middle. Then, the right arm folds the shorts in half from right to left to complete the fold. | ✅'
      },
      {
        ...
        caption: 'Prompt | Both arms fold the bottom of the camo-grey shorts toward the middle. Then, the right arm folds the shorts in half from right to left to complete the task. | ✅'
      },
      {
        ...
        caption: 'Prompt | Both arms fold the bottom of the white shorts toward the middle. Then, the right arm folds the shorts in half from right to left to complete the task. | ✅'
      },
      {
        ...
        caption: 'Prompt | Both arms fold the bottom of the grey shorts toward the middle. Then, the right arm folds the shorts in half from right to left to complete the fold. | ⚠️'
      },
      {
        ...
        caption: 'Prompt | Both arms fold the bottom of the red shorts toward the middle. Then, the right arm folds the shorts in half from right to left to complete the fold. | ⚠️'
      },
      {
        ...
        caption: 'Prompt | Both arms fold the bottom of the dark blue shorts toward the middle. Then, the right arm folds the shorts in half from right to left to complete the fold. | ⚠️'
      },
      {
        ...
        caption: 'Prompt | Both arms fold the bottom of the green shorts toward the middle. Then, the right arm folds the shorts in half from right to left to complete the fold. | ⚠️'
      },
      {
        ...
        caption: 'Prompt | Both arms fold the bottom of the teal shorts toward the middle. Then, the right arm folds the shorts in half from right to left to complete the fold. | ⚠️'
      },
    ],
  },
  seen_4: {
    neural: [
      {
        ...
        caption: 'Prompt | Both arms pick up the black shirt and place it on the stack of clothes. | ✅'
      },
      {
        ...
        caption: 'Prompt | Both arms pick up the folded yellow shirt and place it on the stack of clothes. | ✅'
      },
      {
        ...
        caption: 'Prompt | Both arms pick up the white shirt and place it on the gray towel. | ✅'
      },
      {
        ...
        caption: 'Prompt | Both arms pick up the green shirt and place it on the stack of clothes. | ✅'
      },
      {
        ...
        caption: 'Prompt | Both arms pick up the black hoodie and place it on the stack of clothes. | ✅'
      },
      {
        ...
        caption: 'Prompt | Both arms pick up the dark gray shirt and place it on the stack of clothes. | ✅'
      },
      {
        ...
        caption: 'Prompt | Both arms pick up the blue shirt and place it on the stack of clothes. | ✅'
      },
      {
        ...
        caption: 'Prompt | Both arms pick up the gray logo shirt and place it on the stack of clothes. | ⚠️'
      },
    ],
  },
  seen_5: {
    neural: [
      {
        ...
        caption: 'Prompt | The left arm picks up the Pink Fork from the table and places it onto the blue plate. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the Pink Spoon from the table and places it into the brown packing box. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the  orange spoon from the table and places it into the green plastic mug | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picks up the light blue fork from the table and places it onto the orange plate | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the blue spoon from the table and places it into the red hat | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picks up the green fork from the table and places it into the blue plate.  | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the spoon from the table and places it into the pink bowl | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picks up the orange fork from the table and places it into the glass cup | ⚠️'
      },
    ],
  },
  seen_6: {
    neural: [
      {
        ...
        caption: 'Prompt | The left arm picks up the Mango from the plastic bag and places it into the Wooden Basket | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the Green Pear from the plastic bag and places it into the wooden bowl. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picks up the yellow pear from the plastic bag and places it onto the blue tray. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the red apple from the plastic bag and places it into the green tray. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picks up the purple grapes from the plastic bag and places it into the brown basket. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the peach from the plastic bag and places it into the brown bowl. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picks up the watermelon from the plastic bag and places it onto the Blue Plate. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the starfruit from the plastic bag and places it into the pink bowl. | ✅'
      },
    ],
  },
  seen_7: {
    neural: [
      {
        ...
        caption: 'Prompt | The left arm picks up the Red Marker pen from the table and placed it into the pen holder. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picked up the Black Marker pen from the table and placed it into the pen holder. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picked up the white marker pen from the table and placed it into the pen holder. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picked up the purple pen from the table and placed it into the pen holder. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picked up the mechanical pencil from the table and placed it into the pen holder. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picked up the black marker from the table and placed it into the pen holder. | ⚠️'
      },
      {
        ...
        caption: 'Prompt | The right arm picked up the blue pen from the table and placed it into the pen holder. | ❌'
      },
      {
        ...
        caption: 'Prompt | The right arm picked up the yellow pen from the table and placed it into the pen holder. | ❌'
      },
    ],
  },
  seen_8: {
    neural: [
      {
        ...
        caption: 'Prompt | The left arm picks up the clear cup from the table and places it on the grey coaster. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picks up the plastic cup from the table and places it on the blue coaster. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the paper cup from the table and places it on the blue coaster. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picks up the plastic cup from the table and places it on the white coaster. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the paper cup from the table and places it on the white coaster. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm picks up the blue cup from the table and places it on the gray coaster. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the pink cup from the table and places it on the grey coaster. | ❌'
      },
      {
        ...
        caption: 'Prompt | The right arm picks up the green cup from the table and places it on the gray coaster. | ❌'
      },
    ],
  },
  seen_9: {
    neural: [
      {
        ...
        caption: 'Prompt | The left arm uses a sponge to wipe the coffee spill off the table. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm uses a grey towel to wipe the brown sugar off the table. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm used a black cloth to wipe the white powder off the table. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm used a board eraser to wipe the red marking off the table. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm uses a napkin to wipe the creamer spill off the table. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm uses a baby wipe to wipe the ketchup spill off the table. | ✅'
      },
      {
        ...
        caption: 'Prompt | The left arm used a paper towel to wipe the water off the table. | ✅'
      },
      {
        ...
        caption: 'Prompt | The right arm used a disinfecting wipe to wipe the fruit juice off the table. | ✅'
      },
    ],
  },
  seen_10: {
    neural: [
      {
        ...
        caption: 'Prompt | The robot reaches to grip the green bowl, moves it to the middle wooden bowl, and releases it to stack. It then reaches to grip the white bowl, moves it to the same location, and releases it onto the stack. | ✅'
      },
      {
        ...
        caption: 'Prompt | The robot reaches its right arm to grip the red cup, moves it over the middle clear cup, and releases it to stack. It then reaches its right arm to grip the pink cup, moves it over the stack, and releases it to finish the task. | ✅'
      },
      {
        ...
        caption: 'Prompt | The robot reaches its right arm to grip the green cup, moves it over the middle blue tray, and releases it to stack. It then reaches its right arm to grip the paper cup, moves it over the stack, and releases it to finish the task. | ✅'
      },
      {
        ...
        caption: 'Prompt | The robot reaches its left arm to grip the paper bowl, moves it over the middle white bowl, and releases it to stack. It then reaches its left arm to grip the blue checkered bowl, moves it over the stack, and releases it to finish the task. | ✅'
      },
      {
        ...
        caption: 'Prompt | The robot reaches its left arm to grip the pink bowl, moves it over the middle beige bowl, and releases it to stack. It then reaches its left arm to grip the white bowl, moves it over the stack, and releases it onto the stack. | ✅'
      },
      {
        ...
        caption: 'Prompt | The robot reaches its right arm to grip the beige cup, moves it over the middle green cup, and releases it to stack. It then reaches its right arm to grip the red cup, moves it over the stack, and releases it to finish the task. | ⚠️'
      },
      {
        ...
        caption: 'Prompt | The robot reaches its left arm to grip the blue plate, moves it to the middle light green plate, and releases it to stack. It then reaches its right arm to grip the red plate, moves it over the middle stack of plates, and releases it to finish the task. | ⚠️'
      },
      {
        ...
        caption: 'Prompt | The robot reaches its right arm to grip the paper cup, moves it to the bottom right plastic cup, and releases it to stack. It then reaches its right arm to grip the top right plastic cup, moves it over the stack, and releases it to finish the task. | ❌'
      },
  ...
  unseen_1: { // Untie Shoe/gift
    neural: [
      ...
      },
      {
        ...
        caption: 'Prompt | The robot coordinates both arms to simultaneously grasp the two loops of the shoelace. It then moves both arms outward in synchronized, opposing directions until the shoelace is fully untied. | ⚠️'
      },
      {
        ...
        caption: 'Prompt | The robot reaches its left arm to grasp the white box and hold it steady. It then reaches its right arm toward the red ribbon and moves it to untie the knot. | ⚠️'
      },
      {
      ...
      },
      {
        ...
        caption: 'Prompt | The robot coordinates both arms to simultaneously grasp the two loops of the knot of the box. It then moves both arms outward in synchronized, opposing directions until the knot of the box is fully untied. | ⚠️'
      },
      {
        ...
        caption: 'Prompt | The robot coordinates both arms to simultaneously grasp the two loops of the black rope. It then moves both arms outward in synchronized, opposing directions until the black rope is fully untied. | ❌'
      },
    ],
  },
  unseen_2: {
