...
export default function Footer() {
  return (
    <div className={styles.footer}>
      {/* Global footer */}
      <div className={styles['global-footer-container']}>
        <div className={styles['global-footer']} id="globalFooter">
          <svg className={styles['global-footer__logo']} xmlns="http://www.w3.org/2000/svg" viewBox="0 407.8 1000 184.4"
          ...
          <div className={styles['global-footer__region']}>
            {/* <a href="https://www.nvidia.com/object/country-selector.html" target="_self">
              <span className={styles['global-footer__region__label']}>
                United States
              </span>
            </a> */}
          </div>
          <ul className={styles['global-footer__links']}>
            <li>
            ...
            <li>
              <a href="https://www.nvidia.com/en-us/privacy-center/" target="_blank"
                rel="noopener noreferrer">Manage My Privacy</a>
            </li>
            <li>
              <a href="https://www.nvidia.com/en-us/preferences/email-preferences/" target="_blank"
                rel="noopener noreferrer">Do Not Sell or Share My Data</a>
            </li>
            <li>
            ...
            <li>
              <a href="https://www.nvidia.com/en-us/product-security/" target="_blank"
                rel="noopener noreferrer">Product Security</a>
            </li>
            <li>
              <a href="https://www.nvidia.com/en-us/contact/" target="_blank" rel="noopener noreferrer">Contact</a>
            </li>
          </ul>
          <div className={styles['global-footer__copyright']}>Copyright © 2025 NVIDIA Corporation</div>
        </div>
      </div>
    </div>
  );
